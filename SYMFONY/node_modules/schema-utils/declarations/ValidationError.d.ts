...
export type ValidationErrorConfiguration =
  import("schema-utils/declarations/validate").ValidationErrorConfiguration;
export type PostFormatter = import("schema-utils/declarations/validate").PostFormatter;
export type SchemaUtilErrorObject = import("schema-utils/declarations/validate").SchemaUtilErrorObject;
