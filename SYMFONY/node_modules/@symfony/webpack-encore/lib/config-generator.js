...
const WebpackConfig = require('@symfony/webpack-encore/lib/WebpackConfig'); //eslint-disable-line no-unused-vars
const cssExtractLoaderUtil = require('@symfony/webpack-encore/lib/loaders/css-extract');
const pathUtil = require('@symfony/webpack-encore/lib/config/path-util');
const featuresHelper = require('@symfony/webpack-encore/lib/features');
// loaders utils
const cssLoaderUtil = require('@symfony/webpack-encore/lib/loaders/css');
const sassLoaderUtil = require('@symfony/webpack-encore/lib/loaders/sass');
const lessLoaderUtil = require('@symfony/webpack-encore/lib/loaders/less');
const stylusLoaderUtil = require('@symfony/webpack-encore/lib/loaders/stylus');
const babelLoaderUtil = require('@symfony/webpack-encore/lib/loaders/babel');
const tsLoaderUtil = require('@symfony/webpack-encore/lib/loaders/typescript');
const vueLoaderUtil = require('@symfony/webpack-encore/lib/loaders/vue');
const handlebarsLoaderUtil = require('@symfony/webpack-encore/lib/loaders/handlebars');
// plugins utils
const miniCssExtractPluginUtil = require('@symfony/webpack-encore/lib/plugins/mini-css-extract');
const deleteUnusedEntriesPluginUtil = require('@symfony/webpack-encore/lib/plugins/delete-unused-entries');
const entryFilesManifestPlugin = require('@symfony/webpack-encore/lib/plugins/entry-files-manifest');
const manifestPluginUtil = require('@symfony/webpack-encore/lib/plugins/manifest');
const variableProviderPluginUtil = require('@symfony/webpack-encore/lib/plugins/variable-provider');
const cleanPluginUtil = require('@symfony/webpack-encore/lib/plugins/clean');
const definePluginUtil = require('@symfony/webpack-encore/lib/plugins/define');
const terserPluginUtil = require('@symfony/webpack-encore/lib/plugins/terser');
const optimizeCssAssetsUtil = require('@symfony/webpack-encore/lib/plugins/optimize-css-assets');
const vuePluginUtil = require('@symfony/webpack-encore/lib/plugins/vue');
const friendlyErrorPluginUtil = require('@symfony/webpack-encore/lib/plugins/friendly-errors');
const assetOutputDisplay = require('@symfony/webpack-encore/lib/plugins/asset-output-display');
const notifierPluginUtil = require('@symfony/webpack-encore/lib/plugins/notifier');
const eslintPluginUtil = require('@symfony/webpack-encore/lib/plugins/eslint');
const PluginPriorities = require('@symfony/webpack-encore/lib/plugins/plugin-priorities');
const applyOptionsCallback = require('@symfony/webpack-encore/lib/utils/apply-options-callback');
const copyEntryTmpName = require('@symfony/webpack-encore/lib/utils/copyEntryTmpName');
const getVueVersion = require('@symfony/webpack-encore/lib/utils/get-vue-version');
const tmp = require('tmp');
const fs = require('fs');
const path = require('path');
const stringEscaper = require('@symfony/webpack-encore/lib/utils/string-escaper');
