...
const RuntimeConfig = require('@symfony/webpack-encore/lib/config/RuntimeConfig'); //eslint-disable-line no-unused-vars
const logger = require('@symfony/webpack-encore/lib/logger');
const regexpEscaper = require('@symfony/webpack-encore/lib/utils/regexp-escaper');
const { calculateDevServerUrl } = require('@symfony/webpack-encore/lib/config/path-util');
